...
public class AiOzoneInitDAOImpl implements IAiProcessInitDAO
{
    ...
    {
        String strQuery = "SELECT * FROM TB_AI_IO_INIT";
    ...
    {
        String strQuery = "SELECT * FROM TB_AI_IO_INIT WHERE itm=?";
        try
        {
    ...
    {
        String strQuery = "UPDATE TB_AI_IO_INIT SET init_val=? WHERE itm='io_operation_mode'";
    ...
    {
        String strQuery = "UPDATE TB_AI_IO_INIT SET init_val=? WHERE itm=?";
