...
//    {
//        log.debug("Recv postDiatom:[{}]", diatom.getUpdate_time());
//        // Check Access Token
...
//            log.debug("addDiatom:[{}], result:[{}]", diatom.getMeasure_time(), nResult);
//            if(nResult > 0)
//            {
...
//                {
//                    log.debug("Send diatom information to SCADA Server1:[{}]", response1.getStatusLine().getStatusCode());
//                    log.debug("Send diatom information to SCADA Server2:[{}]", response2.getStatusLine().getStatusCode());
//                }
//                else
//                {
//                    log.debug("Send diatom information to SCADA Server, Response null...");
//                }
//
...
//    {
//        log.debug("Recv getDiatom");
//
//        List<DiatomDTO> diatomList = databaseService.getDiatom();
//        log.debug("getDiatom, result:[{}]", diatomList.size());
...
//    {
//        log.debug("Recv putDiatom:[{}]", diatom_index);
//        // Check Access Token
//        boolean bFindToken = false;
//        int nAuthority;
//        AccessTokenDTO accessTokenDTO = databaseService.getToken(token);
...
//            log.debug("modDiatom:[{}], result:[{}]", diatom_index, nResult);
//            if(nResult > 0)
//            {
//                // Make Response Body
//                Map<String, Object> responseBody = new HashMap<>();
...
//    {
//        log.debug("Recv deleteDiatom:[{}]", diatom_index);
//        // Check Access Token
//        boolean bFindToken = false;
//        int nAuthority;
//        AccessTokenDTO accessTokenDTO = databaseService.getToken(token);
...
//            log.debug("delDiatom:[{}], result:[{}]", diatom_index, nResult);
//            if(nResult > 0)
//            {
