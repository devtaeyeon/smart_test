...
public class CommonValue {
    ...
    // Alarm ID
    public static int ALARM_RECEIVING_AI_CONTROL = 131205;
    ...
    public static int ALARM_MIXING_AI_CONTROL = 133101;
    ...
    public static final String ALARM_CODE_DISINFECTION_AI_CONTROL = "disinfection_ai_control";
    ...
    public static final String ALARM_RECEIVING_AI_THRESHOLD_EXCEEDED = "receiving_ai_threshold_exceeded";
    public static final String ALARM_COAGULANT_AI_THRESHOLD_EXCEEDED = "coagulant_ai_threshold_exceeded";
    public static final String ALARM_MIXING_AI_THRESHOLD_EXCEEDED = "mixing_ai_threshold_exceeded";
    public static final String ALARM_SEDIMENTATION_AI_THRESHOLD_EXCEEDED = "sedimentation_ai_threshold_exceeded";
    public static final String ALARM_FILTER_AI_THRESHOLD_EXCEEDED = "filter_ai_threshold_exceeded";
    public static final String ALARM_DISINFECTION_AI_PRE_THRESHOLD_EXCEEDED = "disinfection_ai_pre_threshold_exceeded";
    public static final String ALARM_DISINFECTION_AI_PERI_THRESHOLD_EXCEEDED = "disinfection_ai_peri_threshold_exceeded";
    public static final String ALARM_DISINFECTION_AI_POST_THRESHOLD_EXCEEDED = "disinfection_ai_post_threshold_exceeded";
    ...
    public static final String PROCESS_GAC = "I";
    public static final String PROCESS_OZONE = "IO";
    public static final String PROCESS_EMS = "EMS";
    public static final String PROCESS_DISINFECTION_POST = "G_POST";
    public static final String NONE = "NONE";
    public static final String DISINFECTION_PRE = "PRE";
    public static final String DISINFECTION_POST = "POST";
    // Filter State 변경
    public static int FILTER_STATE_ING = 1; // 여과중
    public static int FILTER_STATE_BW_WAIT = 2; // 역세대기중
    public static int FILTER_STATE_BW_ING = 3; // 역세중
    public static int FILTER_STATE_WAIT = 4; // 여과대기중
    public static int FILTER_STATE_DR_ING = 5; // 시동방수중
    public static int FILTER_STATE_REST = 6; // 운휴중
    ...
    public static String F_LOCATION_WL_MAX = "f_location_wl_max";
    public static String I_LOCATION_TI_SET_MAX = "AII-2005";

    // 공정 단계
    public static int[] PROCESS_STEP_ARRAY = { 1, 2, 3 };
    // 소독 전차염 단계
