...
//    List<AlarmNotifyDTO> getAlarmNotifyFromAckState(boolean ackState);    // 알람 네비게이터 삭제
    ...
    int modAiFilterInitTi(float value, String itm);
    ...
    ////////////////////////////////////////////
    List<AiDisinfectionRealtimeDTO> getAiDisinfectionRealtimeValueFromUpdateTime(InterfaceDateSearchDTO dto, int disinfectionIndex, int processStep);
    AiDisinfectionRealtimeDTO getLatestAiDisinfectionRealtimeValue(int disinfectionIndex, int processStep);
    int delAiDisinfectionRealtimeValue(Date updateTime, int disinfectionIndex, int processStep);
    ...
    int modAiDisinfectionOperationMode(int operationMode, int processStep, int disinfectionStep);
    ...
    int modUsrMng(String string, String c_cf_coagulant);
    Map<String, Object> selectUsrMng(String item);
    ...
    AiFactorDTO getAiFactorData(AiFactorDTO dto);
    
    //AI누적운영시간
    List<AiOprRealTimeDTO> getAllAiOprRealTime();
    int modAiOprRealTime(String process, String disinfectionStep, int value, int processStep);
    int addAiOprHistoryList(List<AiOprHistoryDTO> aiOprHistoryList);
    int modAllAiOprRealTime();
    List<AiOprHistoryDTO> getAllAiOprHistory();
    List<AiOprHistoryDTO> getAiOprHistoryBySearchDate(InterfaceDateSearchDTO dto);
