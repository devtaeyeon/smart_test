...
public class AiDisinfectionRealtimeDTO
{
    ...
    private Float ai_g_pre_evaporation;    // AI 전염소 1계열 증발량 예측
    ...
    private Float g_pre_chlorination;      // 전염소 1계열 현재 주입률
    ...
    private Float ai_g_chol_rate;   // AI 전염소 1계열 주입률 예측
    ...
    private Float g_e_residual_cl;                    // 1계열 침전지 잔류염소
    ...
    private Float ai_g_correct_degree;  // 이전 주입률 보정예측
    private Float g_pre_chol_rate;  // 전차염 현재 주입률
    private Float g_d_residual_cl;  // 2단계생활 혼화지 잔류염소
