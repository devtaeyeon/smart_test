...
public class AiCoagulantAlarmDAOImpl implements IAiProcessAlarmDAO
{
    ...
    {
        String strQuery = "insert into TB_AI_C_ALM values (?, ?, ?)";
    ...
    {
        String strQuery = "DELETE FROM TB_AI_C_ALM WHERE alm_ti<?";
    ...
    public String getTableByProcessStep(int processStep) {
        String tableNm = "";
        if(processStep == 1) {
            tableNm = "TB_AI_C1_ALM";
        } else if(processStep == 2) {
            tableNm = "TB_AI_C2_ALM";
        } else if(processStep == 3) {
            tableNm = "TB_AI_C3_ALM";
        }
        return tableNm;
    }
}
