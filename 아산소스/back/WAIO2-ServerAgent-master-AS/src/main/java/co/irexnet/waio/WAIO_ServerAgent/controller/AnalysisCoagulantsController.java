...
//    {
//        log.debug("Recv getCoagulantsAnalysis");
//
//        List<CoagulantsAnalysisDTO> coagulantsAnalysisList = databaseService.getAllCoagulantsAnalysis();
//        log.debug("getAllCoagulantsAnalysis, result:[{}]", coagulantsAnalysisList.size());
...
//    {
//        log.debug("Recv getLatestCoagulantsAnalysis");
//
//        CoagulantsAnalysisDTO coagulantsAnalysis = databaseService.getLatestCoagulantsAnalysis();
//
//        log.debug("getLatestCoagulantsAnalysis, result:[{}]", coagulantsAnalysis != null ? 1 : 0);
...
//    {
//        log.debug("Recv getClusterCoagulantsAnalysis");
//
//        List<ClusterInfoDTO> clusterInfoList = databaseService.getAllCoagulantsClusterInfo();
//        log.debug("getAllCoagulantsClusterInfo, result:[{}]", clusterInfoList.size());
//
...
//    {
//        log.debug("Recv postRawwaterAnalysis");
//
//        int nResult = databaseService.addRawWaterClassInfo(classInfo);
//        log.debug("insert class_info, class_index:[{}]", classInfo.getClass_index());
//        if(nResult > 0)
//        {
...
//    }
//
//    @RequestMapping(value = "/coagulants/rawwater/{processStep}", method = RequestMethod.GET)
//    public ResponseEntity<String> getRawwaterAnalysis(@PathVariable int processStep)
//    {
//        log.debug("Recv getRawwaterAnalysis");
//
//        // TODO 테이블 생성 후 주석제거
...
//        log.debug("GetAllRawWaterClassInfo, result:[{}]", classInfoList.size());
//
...
//    {
//        log.debug("Recv putRawwaterAnalysis[{}]", classIndex);
//
//        classInfo.setClass_index(classIndex);
//
//        int nResult = databaseService.modRawWaterClassInfo(classInfo);
//        log.debug("modRawWaterClassInfo[{}], result:[{}]", classIndex, nResult);
//
//        if(nResult > 0)
//        {
...
//    {
//        log.debug("Recv delRawwaterAnalysis[{}]", classIndex);
//
//        int nResult = databaseService.delRawWaterClassInfo(classIndex);
//        log.debug("delRawWaterClassInfo[{}], result:[{}]", classIndex, nResult);
//
//        if(nResult > 0)
//        {
...
//    {
//        log.debug("Recv getTimeCoagulantsAnalysis");
//
//        List<CoagulantsAnalysisDTO> coagulantsAnalysisList = databaseService.get2LatestCoagulantsAnalysis();
//        log.debug("get2LatestCoagulantsAnalysis, result:[{}]", coagulantsAnalysisList.size());
//
//        if(coagulantsAnalysisList.size() > 0)
//        {
...
//    {
//        log.debug("Recv getAnalysisCoagulantsMinute");
//
...
//
//        log.debug("getMinuteCoagulantsAnalysis, result:[{}]", coagulantsAnalysisList.size());
//        if(coagulantsAnalysisList.size() > 0)
//        {
//            // Make Response Body
//            Map<String, Object> responseBody = new HashMap<>();
