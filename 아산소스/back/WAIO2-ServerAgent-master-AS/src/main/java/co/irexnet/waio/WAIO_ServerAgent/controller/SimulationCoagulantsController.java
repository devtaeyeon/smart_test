...
//import co.irexnet.waio.WAIO_ServerAgent.dto.InterfaceSimulationCoagulantsSetDTO;
...
//    {
//        log.debug("Recv postSimulationCoagulants");
//
...
//        log.debug("insert coagulants_simulation, userid:[{}], result:[{}]", coagulantsSimulationDTO.getUserid(), nResult);
//        if(nResult > 0)
//        {
...
//    {
//        log.debug("Recv postSimulationCoagulantsSet");
//        // Check Access Token
...
//    {
//        log.debug("Recv getAllSimulationCoagulants");
//
//        List<CoagulantsSimulationDTO> coagulantsSimulationList = databaseService.getAllCoagulantsSimulation();
//        log.debug("getAllCoagulantsSimulation, result:[{}]", coagulantsSimulationList.size());
...
//    {
//        log.debug("Recv getUncompletedSimulationCoagulants");
//
...
//        log.debug("getCoagulantsSimulationLowerState, result:[{}]", coagulantsSimulationList.size());
//        if(coagulantsSimulationList.size() > 0)
//        {
//            // Make Response Body
//            Map<String, Object> responseBody = new HashMap<>();
...
//    {
//        log.debug("Recv getCompletedSimulationCoagulants");
//
//        List<CoagulantsSimulationDTO> coagulantsSimulationList =
//                databaseService.getCoagulantsSimulationUpperState(CommonValue.STATE_STANDBY);
//        log.debug("getCoagulantsSimulationUpperState, result:[{}]", coagulantsSimulationList.size());
//        if(coagulantsSimulationList.size() > 0)
//        {
//            // Make Response Body
//            Map<String, Object> responseBody = new HashMap<>();
