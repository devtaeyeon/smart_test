...
public class AiReceivingAlarmDAOImpl implements IAiProcessAlarmDAO
{
    ...
    {
        String strQuery = "insert into TB_AI_B2_ALM values (?, ?, ?)";
    ...
    public int delete(Date date) {
        String strQuery = "DELETE FROM TB_AI_B2_ALM WHERE alm_ti<?";
    ...
    public String getTableByProcessStep(int processStep) {
        String tableNm = "";
        if(processStep == 1) {
            tableNm = "TB_AI_B1_ALM";
        } else if(processStep == 2) {
            tableNm = "TB_AI_B2_ALM";
        } else if(processStep == 3) {
            tableNm = "TB_AI_B3_ALM";
        }
        return tableNm;
    }
