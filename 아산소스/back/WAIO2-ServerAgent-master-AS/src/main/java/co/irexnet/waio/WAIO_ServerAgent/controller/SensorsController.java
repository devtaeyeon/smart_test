...
//    {
//        log.debug("Recv getLatestSensors");
//
//        SensorDTO sensorDTO = databaseService.getLatestSensor();
//        log.debug("getLatestSensor result:[{}]", sensorDTO != null ? 1 : 0);
//
//        if(sensorDTO != null)
//        {
//            // Make Response Body
...
//    {
//        log.debug("Recv getHistorySensors");
//
//        List<CoagulantsDTO> coagulantsList = databaseService.getHistorySensor();
//        log.debug("getHistorySensor result:[{}]", coagulantsList.size());
//
...
//    {
//        log.debug("Recv getCoagulantsSensors");
//
//        CoagulantsDTO coagulantsDTO = databaseService.getLatestCoagulants();
//        log.debug("getLatestCoagulants result:[{}]", coagulantsDTO == null ? 0 : 1);
//
...
//    {
//        log.debug("Recv getTbTrendSensors");
//
...
//        log.debug("getDistinctCountHsE1Tb, result:[{}]", frequencyList.size());
...
//        log.debug("getDistinctCountHsE2Tb, result:[{}]", frequencyList.size());
//        nTotalSize += frequencyList.size();
//
...
//        log.debug("getDistinctCountHsFTb, result:[{}]", frequencyList.size());
//        nTotalSize += frequencyList.size();
//
//        countBody = new HashMap<>();
//        for(FrequencyDTO dto : frequencyList)
...
//        log.debug("getSensor, result:[{}]", sensorList.size());
//
...
//    {
//        log.debug("Recv getLatestTbTrendSensors");
//
//        // Get Latest sensor
//        SensorDTO sensorDTO = databaseService.getLatestSensor();
//        log.debug("getLatestSensor, result:[{}]", sensorDTO != null ? 1 : 0);
...
//    {
//        log.debug("Recv getTbHsSensors, start:[{}], end:[{}]", dateSearchDTO.getStart_time(), dateSearchDTO.getEnd_time());
//
//        // Get hs tb data
//        List<TrendTbDTO> trendTbList = databaseService.getTrendTb(dateSearchDTO);
//        log.debug("getTrendTb, result:[{}]", trendTbList.size());
//
...
//    {
//        log.debug("Recv getCodeHsSensors, code:[{}], start:[{}], end:[{}]",
...
//        log.debug("getTrendCode, code:[{}], result:[{}]", code, trendCodeList.size());
//
