...
public class AiSedimentationRealtimeDTO
{
    ...
    private String AIE_9011;    // 11지 세부 현황
    private String AIE_9012;    // 12지 세부 현황
    // TOBE 추가
    private Float AIE_5300;		// AI 침전지 슬러지 발생량 예측
    private Float c_mm_fr;      // 약품 주입량
    private Float c_mm_fr1;     // 3단계공업 약품 주입량1
    private Float c_mm_fr2;     // 3단계공업 약품 주입량2
    private Float c_mm_fr3;     // 3단계공업 약품 주입량3
    private Float c_mm_fr_etc;  // 1단계공업 보조약품 주입량
    private Float c_mm_fr_etc1; // 2,3단계 보조약품 주입량1
    private Float c_mm_fr_etc2; // 2,3단계 보조약품 주입량2
    private Float c_mm_fr_etc3; // 3단계 보조약품 주입량3
}
