...
public class AiCoagulantRealtimeDTO
{
    ...
    //private String e_ser_tb_b;              // 침전지 후탁도
    private Integer ai_clst_id;      // 클러스터 ID
    private String ai_c_cglnt;      // AI 약품 종류 예측
    private String ai_c_fnl;          // AI 약품 주입률 최종값
    private String ai_c_rst;         // AI 약품 주입률 예측
    private String ai_c_crt;      // AI 약품 주입률 보정값
    private String in_val;
    private String out_val;
    
    private String ai_c_cf;			// AI 약품 주입률 최종값
    private Float c_tb; 			// 침전지 탁도 트렌드
    private Float cTbE;
    private int c_injector1;
    private int c_injector2;
    private int c_injector3;
    private int c_injector4;
