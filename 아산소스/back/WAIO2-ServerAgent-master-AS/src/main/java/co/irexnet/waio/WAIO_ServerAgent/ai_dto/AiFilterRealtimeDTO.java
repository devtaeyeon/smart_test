...
public class AiFilterRealtimeDTO
{
    ...
    private String ai_f_bw_start_ti;   // AI 지별 역세 시작 시간 예측
    ...
    private String ai_f_location_operation;       
    private String ai_f_schedule;
    private String ai_f_bw_wait_time;   // 역세대기시간(지별) 예측
    private String f_rest;              // 운휴중
    private String f_time_per;          // 여과지속시간(지별)
    private String f_time_bw_per;       // 역세후대기시간(지별)
