  ...
  <div class="main">
    ...
    <div class="bottom-one">
      ...
      <div class="box-container">
        ...
        <div class="box-contents">
          <div class="box-value">
            <div class="box-value__text">· 원수 유입 유량</div>
            <div class="box-value__value">{{ this.$store.state.filter.latest.b_in_fr | numFormat('0,0')}}</div>
            <div class="box-value__unit">m<sup>3</sup>/h</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 침전수 탁도</div>
    ...
    <div class="bottom-two">
      ...
      <div class="bottom-box">
        ...
        <div class="bottom-box__title">운영지수 <span>{{ this.$store.state.filter.latest.ai_f_num_fil }}</span> 지</div>
    ...
    <div class="bottom-chart">
      <div class="bottom-chart__title">
        ...
        <div class="bottom-chart__timerbox-outter">
          <div class="timerbox">
            {{ this.$store.state.filter.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
          </div>
        </div>
      </div>
      <div class="chart-box">
...
import AILocationChart from '@/components/filter/chart/AILocationChart'
