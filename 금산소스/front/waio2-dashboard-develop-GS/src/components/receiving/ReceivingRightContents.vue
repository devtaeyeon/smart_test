<template>
  <div>
    <!-- <div class="btn-tab">
        ...
        <div class="btn-tab__box-disabled box-center-margin">공업</div>
    </div> -->
      ...
      <div class="last-container">
        ...
        <div class="first">
          ...
          <div class="last-result-contents paddingtop">
            ...
            <div class="value-box">
              <div class="value-box__value">{{ 100 | numFormat('0') }}</div>
...
.center-container{
  ...
  .img-contents{
    width: 463px;
    height:502px;
    background-image: url('../../assets/ss_images/sub_06.png');
