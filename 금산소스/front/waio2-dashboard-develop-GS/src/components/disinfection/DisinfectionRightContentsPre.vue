<template>
  <div class="main">
    <div class="top-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.b_tb | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">. 원수 pH</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.b_ph | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">. 원수 전기전도도</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.b_cu | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">. 원수 알카리도</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.b_al | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">. 취수 망간</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.mnr | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 원수 유입 유량(m<sup>3</sup>/h)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.b_in_fr | numFormat('0,0') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.disinfection.latest.d_ser_in_fr | numFormat('0,0') }}</div> -->
            </div>
            <div class="value-container">
              <div class="value-container__one">· 혼화지 잔류 염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_d_residual_cl | numFormat('0.00') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.disinfection.latest.d_ser_cl | numFormat('0.0') }}</div> -->
            </div>
            <div class="value-container">
              <div class="value-container__one">· 원수 잔류 염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_b_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_pre_chol_rate | numFormat('0.00') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_pre2_chlorination | numFormat('0.0') }}</div> -->
            </div>
          </div>
        </div>
      </div>
      <div class="two-contents">
        ...
        <div class="small-contents">
          <div class="little-title-one">전염소 염소소모량 예측</div>
          <div class="small-contents-value">
            <div class="small-contents-value__title">{{this.$store.state.disinfection.latest.g_pump_1_run == 1? '1' : '2'}}호기</div>
            <div class="value">
              <div class="value__num">{{ this.$store.state.disinfection.latest.ai_g_consumption | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        <div class="three-contents__title">
          ...
          <div class="three-contents__timerbox-outter">
            <div class="timerbox">
              {{ this.$store.state.disinfection.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
            </div>
          </div>
        </div>
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.disinfection.latest.g_pre_chol_rate | numFormat('0.00') }}</div>
          </div> 
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title">{{this.$store.state.disinfection.latest.g_pump_1_run == 1? '1' : '2'}}호기</div>
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.disinfection.latest.ai_g_chol_rate | numFormat('0.00') }}</div>
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">전염소 염소 소모량 예측 </div>
        <div class="contents-gragh">
          <highcharts :options="ChartOptionGConsumption" style="height:100%;"/>
        </div>
      </div>
      <div class="contents paddingleft">
        <div class="contents__title">전염소 주입률 예측 </div>
...
export default {
  ...
  computed: {
    ChartOptionGConsumption: function () {
      let chart = this.chartOptionGConsumption
      let now = new Date()
      ...
      chart.series = []
      if (this.$store.state.disinfection.ai_g_consumption !== null && Object.keys(this.$store.state.disinfection.ai_g_consumption).length > 0) {
        let dataSeries1 = []
        for (let key in this.$store.state.disinfection.ai_g_consumption) {
          dataSeries1.push([new Date(key).getTime(), this.$store.state.disinfection.ai_g_consumption[key]])
        }
        chart.series.push({
          name: '염소소모량',
          data: dataSeries1,
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_후염소 염소 소모량 예측 '
      return chart
    },
    ChartOptionCholRate: function () {
      ...
      chart.series = []
      if (this.$store.state.disinfection.cholrateTrend !== null && Object.keys(this.$store.state.disinfection.cholrateTrend).length > 0) {
        let dataSeries1 = []
        for (let key in this.$store.state.disinfection.cholrateTrend) {
          dataSeries1.push([new Date(key).getTime(), this.$store.state.disinfection.cholrateTrend[key]])
        }
        chart.series.push({
          name: '주입률',
          data: dataSeries1,
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_전차염 주입률 예측 '
      return chart
    },
  },
  methods: {
