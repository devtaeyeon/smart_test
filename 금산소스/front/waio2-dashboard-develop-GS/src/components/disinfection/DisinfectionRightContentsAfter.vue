    ...
    <div class="top-contents">
      ...
      <div class="one-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              <div class="value-container__one">. 원수 온도</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.b_te | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">. 막여과 통합 탁도</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.f_tb | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
            ...
            <div class="value-container">
              <div class="value-container__one">· 정수지 유입 유량(m<sup>3</sup>/h)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.h_in_fr | numFormat('0,0') }}</div>
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_h_in_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 정수지 유출 잔류 염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_h_out_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 정수지 유입 잔류 염소(평활)(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_h_in_residual_cl_prep | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 여과수 통합 잔류 염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_f_out_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_post_chol_rate | numFormat('0.00') }}</div>
      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          <div class="little-title-one">후염소 염소소모량 예측</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.disinfection.latest.g_post_chol_rate | numFormat('0.00') }}</div>
          </div> 
...
export default {
  ...
  computed: {
    ChartOptionGConsumption: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_후염소 주입률 보정값 예측 '
      return chart
    },
