  ...
  <div class="main">
    ...
    <div class="contents-wrap">
      <div class="contents-value">
        <div class="contents-value__row">
          ...
          <div class="contents-value__number"><input v-if="this.$store.state.disinfection.isModifyMode" type="text" :value="this.$store.state.disinfection.latestModify.g_pre_set_max" v-on:input="updateInput($event, 'g_pre_set_max')"/><span v-else>{{ this.$store.state.disinfection.latestModify.g_pre_set_max | numFormat('0.00') }}</span></div>
        </div>
        <div class="contents-value__row">
          <div class="contents-value__title">주입률하한</div>
          <div class="contents-value__number"><input v-if="this.$store.state.disinfection.isModifyMode" type="text" :value="this.$store.state.disinfection.latestModify.g_pre_set_min" v-on:input="updateInput($event, 'g_pre_set_min')"/><span v-else>{{ this.$store.state.disinfection.latestModify.g_pre_set_min | numFormat('0.00') }}</span></div>
        </div>
        <div class="contents-value__row">
          <div class="contents-value__title">1회 변경 주입률</div>
          <div class="contents-value__number"><input v-if="this.$store.state.disinfection.isModifyMode" type="text" :value="this.$store.state.disinfection.latestModify.g_pre_chg_limit_for_onetime" v-on:input="updateInput($event, 'g_pre_chg_limit_for_onetime')"/><span v-else>{{ this.$store.state.disinfection.latestModify.g_pre_chg_limit_for_onetime | numFormat('0.00') }}</span></div>
        </div>
        <div class="contents-value__row">
          <div class="contents-value__title">혼화지 목표<br/>잔류염소</div>
          <div class="contents-value__number"><input v-if="this.$store.state.disinfection.isModifyMode" type="text" :value="this.$store.state.disinfection.latestModify.g_d_obj_residual_cl" v-on:input="updateInput($event, 'g_d_obj_residual_cl')"/><span v-else>{{ this.$store.state.disinfection.latestModify.g_d_obj_residual_cl | numFormat('0.00') }}</span></div>
        </div>
        <div class="contents-value__row">
          <div class="contents-value__title">혼화지 잔류염소<br/>홀딩범위</div>
          <div class="contents-value__number"><input v-if="this.$store.state.disinfection.isModifyMode" type="text" :value="this.$store.state.disinfection.latestModify.g_d_residual_cl_holding" v-on:input="updateInput($event, 'g_d_residual_cl_holding')" maxlength="5"/><span v-else>{{ this.$store.state.disinfection.latestModify.g_d_residual_cl_holding | numFormat('0.00') }}</span></div>
          </div>
        <div class="contents-value__row">
          <div class="contents-value__title">보정주기</div>
          <div class="contents-value__number"><input v-if="this.$store.state.disinfection.isModifyMode" type="text" :value="this.$store.state.disinfection.latestModify.g_pre_calib_cycle" v-on:input="updateInput($event, 'g_pre_calib_cycle')"/><span v-else>{{ this.$store.state.disinfection.latestModify.g_pre_calib_cycle | numFormat('0') }}</span></div>
        </div>
        <div class="contents-value__row">
    ...
    <!-- <div class="contents-value">
      ...
      <div class="contents-value__row">
        ...
        <div class="contents-value__title">보정주기</div>
        <div class="contents-value__title">혼화지목표 <br/>잔류염소</div>
...
export default {
    ...
    updateControl: function() {
      ...
      if (this.$store.state.disinfection.isModifyMode) {
        if (this.$store.state.disinfection.latestModify.g_pre_set_max === ''
           ...
           || this.$store.state.disinfection.latestModify.g_pre_calib_cycle === ''
           || this.$store.state.disinfection.latestModify.g_d_obj_residual_cl === ''
           || this.$store.state.disinfection.latestModify.g_d_residual_cl_holding === '') {
          ...
          obj.g_pre_calib_cycle = this.$store.state.disinfection.latestModify.g_pre_calib_cycle
          obj.g_d_obj_residual_cl = parseFloat(this.$store.state.disinfection.latestModify.g_d_obj_residual_cl)
          obj.g_d_residual_cl_holding = parseFloat(this.$store.state.disinfection.latestModify.g_d_residual_cl_holding)
          ...
          if ((obj.g_d_obj_residual_cl < cl_min_limit || obj.g_d_obj_residual_cl > cl_max_limit)) {
            this.$store.dispatch('alertDialog/OPEN_DIALOG', { title: '경고', text1: '혼화지 목표 잔류염소 설정 범위', text2: cl_min_limit + ' ~ ' + cl_max_limit})
            return
          }
          if ((obj.g_pre_calib_cycle < cycle_min_limit || obj.g_pre_calib_cycle > cycle_max_limit)) {
  ...
  watch: {
    ...
    //   }
    // },
    // '$store.state.disinfection.latestModify.g_d_obj_residual_cl': function(newVal, oldVal) {
    //   if (newVal === '') {
    //     this.$store.state.disinfection.latestModify['g_d_obj_residual_cl'] = newVal
    //   } else {
    //     if (this.checkNumberFormat(newVal)) {
    //       this.$store.state.disinfection.latestModify['g_d_obj_residual_cl'] = newVal
    //     } else {
    //       this.$store.state.disinfection.latestModify['g_d_obj_residual_cl'] = oldVal
    //     }
    //   }
    // },
  }
