...
public class CommonValue
{
    ...
    // Alarm Type
    public static final int ALARM_TYPE_OFF        = 0;
    public static final int ALARM_TYPE_THRESHOLD  = 1;
    public static final int ALARM_TYPE_SEMI_AUTO  = 2;
    public static final int ALARM_TYPE_ANOTHER_SYSTEM = 3;
    public static final int ALARM_TYPE_THRESHOLD_EXCEEDED = 4;
    ...
    // Alarm ID
    public static int ALARM_RECEIVING_AI_CONTROL_LIV        = 131101;
    public static int ALARM_RECEIVING_AI_CONTROL_IND        = 131201;
    public static int ALARM_RECEIVING_AI_MODULE_ERROR_LIV   = 131103;
    public static int ALARM_RECEIVING_AI_MODULE_ERROR_IND   = 131203;
    public static int ALARM_COAGULANT_AI_CONTROL_LIV        = 132101;
    public static int ALARM_COAGULANT_AI_CONTROL_IND        = 132201;
    public static int ALARM_COAGULANT_AI_MODULE_ERROR_LIV   = 132103;
    public static int ALARM_COAGULANT_AI_MODULE_ERROR_IND   = 132203;
    public static int ALARM_MIXING_AI_CONTROL_LIV           = 133101;
    public static int ALARM_MIXING_AI_CONTROL_IND           = 133201;
    public static int ALARM_MIXING_AI_MODULE_ERROR_LIV      = 133103;
    public static int ALARM_MIXING_AI_MODULE_ERROR_IND     	= 133203;
    public static int ALARM_SEDIMENTATION_AI_CONTROL_LIV    = 134101;
    public static int ALARM_SEDIMENTATION_AI_CONTROL_IND   	= 134201;
    public static int ALARM_SEDIMENTATION_AI_MODULE_ERROR_LIV   = 134103;
    public static int ALARM_SEDIMENTATION_AI_MODULE_ERROR_IND   = 134203;
    public static int ALARM_FILTER_AI_CONTROL_LIV           	= 135101;
    public static int ALARM_FILTER_AI_MODULE_ERROR_LIV      	= 135103;

    // 생활 소독
    public static int ALARM_DISINFECTION_AI_PRE_CONTROL_LIV     	= 137111;
    public static int ALARM_DISINFECTION_AI_PRE_MODULE_ERROR_LIV 	= 137113;
    public static int ALARM_DISINFECTION_AI_PERI_CONTROL_LIV     	= 137121;
    public static int ALARM_DISINFECTION_AI_PERI_MODULE_ERROR_LIV 	= 137123;
    public static int ALARM_DISINFECTION_AI_POST_CONTROL_LIV     	= 137131;
    public static int ALARM_DISINFECTION_AI_POST_MODULE_ERROR_LIV 	= 137133;
    
    // 공업 소독
    public static int ALARM_DISINFECTION_AI_CONTROL_IND     	= 137201;
    public static int ALARM_DISINFECTION_AI_MODULE_ERROR_IND 	= 137203;
    ...
    public static final String ALARM_CODE_RECEIVING_AI_CONTROL    = "receiving_ai_control";
    public static final String ALARM_CODE_COAGULANT_AI_CONTROL    = "coagulant_ai_control";
    public static final String ALARM_CODE_MIXING_AI_CONTROL       = "mixing_ai_control";
    public static final String ALARM_CODE_SEDIMENTATION_AI_CONTROL    = "sedimentation_ai_control";
    public static final String ALARM_CODE_FILTER_AI_CONTROL       = "filter_ai_control";
    public static final String ALARM_CODE_GAC_AI_CONTROL          = "gac_ai_control";
    public static final String ALARM_CODE_DISINFECTION_AI_PRE_CONTROL = "disinfection_ai_pre_control";
    public static final String ALARM_CODE_DISINFECTION_AI_PERI_CONTROL = "disinfection_ai_peri_control";
    public static final String ALARM_CODE_DISINFECTION_AI_POST_CONTROL = "disinfection_ai_post_control";
    public static final String ALARM_CODE_OZONE_AI_CONTROL        = "ozone_ai_control";
    
    public static final String ALARM_CODE_RECEIVING_AI_THRESHOLD     = "receiving_ai_threshold_exceeded";
    public static final String ALARM_CODE_COAGULANT_AI_THRESHOLD     = "coagulant_ai_threshold_exceeded";
    public static final String ALARM_CODE_MIXING_AI_THRESHOLD     = "mixing_ai_threshold_exceeded";
    public static final String ALARM_CODE_DISINFECTION_AI_PRE_THRESHOLD  = "disinfection_ai_pre_threshold_exceeded";
    public static final String ALARM_CODE_DISINFECTION_AI_PERI_THRESHOLD  = "disinfection_ai_peri_threshold_exceeded";
    public static final String ALARM_CODE_DISINFECTION_AI_POST_THRESHOLD  = "disinfection_ai_post_threshold_exceeded";

    public static final String ALARM_CODE_CONNECTION_ERROR = "connection_error"; // 통신연결 이상 알람
    ...
    public static int TAG_MANAGE_TYPE_CONTROL = 4;

    // Algorithm Process Code
    public static final String PROCESS_RECEIVING      = "B";
    public static final String PROCESS_COAGULANT      = "C";
    public static final String PROCESS_MIXING         = "D";
    public static final String PROCESS_SEDIMENTATION  = "E";
    public static final String PROCESS_FILTER         = "F";
    public static final String PROCESS_DISINFECTION   = "G";
    public static String PROCESS_GAC            = "I";
    public static String PROCESS_OZONE          = "IO";
    public static String PROCESS_EMS            = "EMS";
    public static final String PROCESS_DISINFECTION_PRE = "G_PRE";
    public static final String PROCESS_DISINFECTION_PERI   = "G_PERI";
    public static final String PROCESS_DISINFECTION_POST   = "G_POST";
...
//    public static int FILTER_STATE_CIRCULATION_STANDBY  = 7;
    ...
    // Filter State 변경
//    public static int FILTER_STATE_READY				= 1;	// 여과준비중
//    public static int FILTER_STATE_ING					= 2;	// 여과중
//    public static int FILTER_STATE_END					= 3;	// 여과종료
//    public static int FILTER_STATE_WAIT					= 4;	// 대기중
//    public static int FILTER_STATE_BW_WAIT				= 5;	// 역세대기중
//    public static int FILTER_STATE_BW_ING				= 6;	// 역세중
//    public static int FILTER_STATE_DR_ING				= 7;	// 시동방수중
//    public static int FILTER_STATE_ETC					= 8;	// 예외상황

    public static int FILTER_STATE_FIL_ING					= 1;	// 여과중
    public static int FILTER_STATE_BW_WAIT					= 2;	// 역세대기중
    public static int FILTER_STATE_BW_ING					= 3;	// 역세중
    public static int FILTER_STATE_FIL_WAIT					= 4;	// 여과대기중
    public static int FILTER_STATE_DR_ING					= 5;	// 시동방수중
    public static int FILTER_STATE_F_REST					= 6;	// 운휴중
    ...
    public static int KAFKA_FLAG_CANCEL       = 4;
    ...
    // Filter/GAC TI
    public static String F_LOCATION_TI_SET_MAX      = "f_location_ti_set_max";
    public static String I_LOCATION_TI_SET_MAX      = "AII-2005";

    public static int[] PROCESS_STEP_ARRAY = {1};
    public static int[] PROCESS_STEP_ARRAY_FILTER = {1};
    
    // 소독 전차염 단계
    public static int DISINFECTION_PRE_STEP = 1;
    // 소독 중차염 단계
    public static int DISINFECTION_PERI_STEP = 2;
    // 소독 후차염 단계
    public static int DISINFECTION_POST_STEP = 3;
    
    public static final String KAFKA_GROUP_ID = "operation";
