...
public class DisinfectionRealtimeDAOImpl implements IProcessRealtimeDAO
{
    ...
    {
        String strQuery = String.format("ALTER TABLE TB_G_RT REORGANIZE PARTITION p_max INTO (" +
    ...
    {
        String strQuery = String.format("ALTER TABLE TB_G_RT DROP PARTITION p_%s", partitiontag_sn);
        jdbcTemplate.execute(strQuery);
    }
