...
//import co.irexnet.waio.WAIO_ServerAgent.resource_dto.*;
...
//    {
//        log.debug("Recv getAllResources");
//
//        // Get system information
//        List<SystemInfoDTO> systemInfoList = databaseService.getAllSystemInfo();
//        log.debug("getAllSystemInfo, result:[{}]", systemInfoList.size());
//
...
//    {
//        log.debug("Recv getResources, Hostname:[{}]", hostname);
//
//        // Get system information
//        SystemInfoDTO systemInfoDTO = databaseService.getSystemInfoFromHostname(hostname);
//        log.debug("getSystemInfoFromHostname:[{}], result:[{}]", hostname, systemInfoDTO != null ? 1 : 0);
//
...
//    {
//        log.debug("Recv putResourcesInfo[{}]", hostname);
//        if(systemName == null)
//        {
...
//            log.debug("modSystemInfoName, result:[{}]", nResult);
//            if(nResult > 0)
//            {
...
//            return new ResponseEntity<>(strErrorBody, HttpStatus.UNAUTHORIZED);
//        }
//        log.debug("Recv putResources[{}]", hostname);
//        //log.debug("{}", resourceMonitorDTO);
//
...
//            {
//                if(disk.getModel().equalsIgnoreCase(diskInfo.getMd()) == true && disk.getSize() == diskInfo.getSize())
//                {
//                    bFind = true;
//                    break;
//                }
...
//                diskInfoDTO.setHost(hostname);
//                diskInfoDTO.setMd(disk.getModel());
//                diskInfoDTO.setSize(disk.getSize());
//
//                log.debug("Not exist disk_info[{}], insert new record", hostname);
...
//                partitionInfoDTO.setHost(hostname);
//                partitionInfoDTO.setNm(partition.getName());
//                partitionInfoDTO.setTot_size(partition.getTotalSize());
//                partitionInfoDTO.setUnu_size(partition.getUsableSize());
//
//                if(databaseService.modPartitionInfo(partitionInfoDTO) <= 0)
//                {
//                    log.debug("Not exist partition_info[{}], insert new record", hostname);
...
//                systemMonitoringDTO.setHost(hostname);
//                systemMonitoringDTO.setMntr_ty(CommonValue.MONITORING_TYPE_PARTITON_USED);
//                systemMonitoringDTO.setMntr_itm(partition.getName());
//                String strUsed = String.format("%.2f", partition.getUsed());
//                systemMonitoringDTO.setMntr_val(strUsed);
...
//            log.debug("host:[{}], disk used:[{}]", hostname, strUsed);
...
//            interfaceInfoDTO.setHost(hostname);
//            interfaceInfoDTO.setNm(interfaceDTO.getName());
//            interfaceInfoDTO.setDp_nm(interfaceDTO.getDisplayName());
...
//            {
//                log.debug("Not exist interface_info[{}], insert new record", hostname);
...
//            SystemMonitoringDTO systemMonitoringDTO = new SystemMonitoringDTO();
//            systemMonitoringDTO.setHost(hostname);
//            systemMonitoringDTO.setMntr_ty(CommonValue.MONITORING_TYPE_SENT_THROUGHPUT);
//            systemMonitoringDTO.setMntr_itm(interfaceDTO.getName());
//            systemMonitoringDTO.setMntr_val(Long.toString(interfaceDTO.getSentBytes()));
//            systemMonitoringDTO.setMntr_upd_ti(new Date());
//            databaseService.addSystemMonitoring(systemMonitoringDTO);
//
...
//            systemMonitoringDTO.setHost(hostname);
//            systemMonitoringDTO.setMntr_ty(CommonValue.MONITORING_TYPE_RECV_THROUGHPUT);
//            systemMonitoringDTO.setMntr_itm(interfaceDTO.getName());
//            systemMonitoringDTO.setMntr_val(Long.toString(interfaceDTO.getRecvBytes()));
//            systemMonitoringDTO.setMntr_upd_ti(new Date());
//            databaseService.addSystemMonitoring(systemMonitoringDTO);
//        }
//
...
//        systemInfoDTO.setHost(hostname);
//
...
//        systemInfoDTO.setMd(computerSystemDTO.getModel());
//
//        ProcessorDTO processorDTO = resourceMonitorDTO.getProcessor();
//        systemInfoDTO.setPrc_nm(processorDTO.getName());
//        systemInfoDTO.setPrc_cnt(processorDTO.getPackageCount());
//        systemInfoDTO.setCore_cnt(processorDTO.getPhysicalCount());
//        systemInfoDTO.setLgc_core_cnt(processorDTO.getLogicalCount());
...
//            log.debug("Modify MaxFrequency -1 to [{}]", strFrequency);
...
//        }
//        systemInfoDTO.setMax_freq(processorDTO.getMaxFrequency());
//
//        MemoryDTO memoryDTO = resourceMonitorDTO.getMemory();
//        systemInfoDTO.setTot_mem(memoryDTO.getTotalMemory());
//        systemInfoDTO.setAvl_mem(memoryDTO.getAvailableMemory());
//
...
//        systemInfoDTO.setSys_upd_ti(new Date());
//
//        // update system information
//        if(databaseService.modSystemInfo(systemInfoDTO) <= 0)
//        {
//            log.debug("Not exist system_info[{}], insert new record", hostname);
//            systemInfoDTO.setSys_nm(hostname);
...
//        SystemMonitoringDTO systemMonitoringDTO = new SystemMonitoringDTO();
//        systemMonitoringDTO.setHost(hostname);
//        systemMonitoringDTO.setMntr_ty(CommonValue.MONITORING_TYPE_PROCESSOR_USED);
//        systemMonitoringDTO.setMntr_itm(processorDTO.getName());
...
//        systemMonitoringDTO = new SystemMonitoringDTO();
//        systemMonitoringDTO.setHost(hostname);
//        systemMonitoringDTO.setMntr_ty(CommonValue.MONITORING_TYPE_MEMORY_USED);
//        systemMonitoringDTO.setMntr_itm("Memory");
...
//                    log.debug("password change remain [{}] days", lDifferentDay);
//
...
//    {
//        log.debug("Recv getMonitoring:[{}]", hostname);
//
//        // 특정 시스템 리소스 모니터링 정보 조회
//        List<SystemMonitoringDTO> systemMonitoringList = databaseService.getSystemMonitoringFromHostname(hostname);
//        log.debug("getSystemMonitoringFromHostname:[{}], result:[{}]", hostname, systemMonitoringList.size());
//
//        if(systemMonitoringList.size() > 0)
//        {
//            // Make Response Body
...
//    {
//        log.debug("Recv getLatestMonitoring");
//
