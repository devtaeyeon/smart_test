...
{
    private Date upd_ti;
    private Integer i_opr_cnt;          // 운영지 수
    ...
    private String i_loc_stt;            // 지별 여과 상태
    private String i_loc_le;               // 지별 수위
    private String e_ser_tb_b;                      // 침전지 후 탁도
    private Float f_tb;                         // 급속여과지 탁도
    private Float i_tb;                         // 활성탄 흡착지 탁도
    private String i_loc_ti;               // 지별 여과 지속시간
    private String ai_i_loc_ti;            // AI 지별 여과 지속시간 예측
    private String i_loc_bw_wt_ti;       // 역세 후 대기 시간
    private String ai_i_loc_bw_ti;   // AI 역세 시작 시간 예측
    private String ai_i_opr_cnt;        // AI 운영지 수 예측
    private String ai_i_loc_opr;     // AI 지별 여과 스케쥴
    private String ai_f_loc_bw_stt;         // AI GAC 여과 운영 스케쥴 표
}
