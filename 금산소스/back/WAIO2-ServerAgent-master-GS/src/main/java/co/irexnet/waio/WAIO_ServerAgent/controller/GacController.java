...
//import co.irexnet.waio.WAIO_ServerAgent.ai_dto.JsonDSeriesFloat;
//import co.irexnet.waio.WAIO_ServerAgent.ai_dto.JsonESeriesFloat;
...
////         AiProcessInitDTO aiGacInit = databaseService.getAiGacInit(CommonValue.I_OPERATION_MODE, 2);
////         log.debug("getAiGacInit(operation_mode), result:[{}]", aiGacInit != null ? 1 : 0);
//
////         // get ai_gac_init(i_location_ti_set_max)
////         AiProcessInitDTO aiGacTi = databaseService.getAiGacInit(CommonValue.I_LOCATION_TI_SET_MAX, 2);
////         log.debug("getAiGacInit(i_location_ti_set_max), result:[{]]", aiGacTi != null ? 1 : 0);
//
////         // get ai_gac_realtime
...
//
////         // get gac_realtime
////         List<ProcessRealtimeDTO> gacRealtime = databaseService.getLatestGacRealtimeValue(strPartitionName, 2);
////         log.debug("getLatestGacRealtimeValue, result:[{}]", gacRealtime.size());
//
////         // get tag_manage(gac)
////         List<TagManageDTO> tagManageList = databaseService.getTagManageFromCode(CommonValue.PROCESS_GAC);
////         log.debug("getTagManageFromCode:[{}], result:[{}]", CommonValue.PROCESS_GAC, tagManageList.size());
//
////         // get location number(지 번호)
////         TagManageRangeDTO gacRange = databaseService.getTagManageRange(CommonValue.PROCESS_GAC);
////         log.debug("getTagManageRange:[{}], result:[{}]", CommonValue.PROCESS_GAC, gacRange != null ? 1 : 0);
//
...
//
////             // update_time
////             aiGacInfo.put("upd_ti", aiGacRealtime.getUpd_ti());
//
////             // operation_mode
////             if(aiGacInit != null)
////             {
////                 aiGacInfo.put("ai_opr", aiGacInit.getInit_val().intValue());
////             }
////             else
////             {
////                 aiGacInfo.put("ai_opr", aiGacRealtime.getAi_opr());
////             }
//
////             // peak_mode
...
////             if(aiGacTi != null)
////             {
////                 aiGacInfo.put("i_location_ti_set_max", aiGacTi.getInit_val().intValue());
////             }
////             else
////             {
...
////                     {
////                         // 1계열 혼화지 유입 유량
////                         aiGacInfo.put(tagManage.getItm(), Float.parseFloat(dto.getTag_val()));
////                         break;
////                     }
...
////                         break;
////                     }
////                     else if(tagManage.getItm().equalsIgnoreCase("i_in_fr") == true &&
////                             tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true)
////                     {
////                         // 활성탄 흡착지 유입 유량
////                         aiGacInfo.put(tagManage.getItm(), Float.parseFloat(dto.getTag_val()));
////                         break;
////                     }
////                     else if(tagManage.getItm().equalsIgnoreCase("i_out_fr") == true &&
////                             tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true)
////                     {
////                         // 활성탄 흡착지 유출 유량
////                         aiGacInfo.put(tagManage.getItm(), Float.parseFloat(dto.getTag_val()));
////                         break;
////                     }
////                     else if(tagManage.getItm().equalsIgnoreCase("i_sp") == true &&
////                             tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true)
////                     {
////                         // 여과 속도
////                         aiGacInfo.put(tagManage.getItm(), Float.parseFloat(dto.getTag_val()));
////                         break;
////                     }
////                     else if(tagManage.getItm().equalsIgnoreCase("i_tb") == true &&
////                             tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true)
////                     {
////                         // 활성탄 흡착지 통합 탁도
////                         aiGacInfo.put(tagManage.getItm(), Float.parseFloat(dto.getTag_val()));
...
////             {
////                 String strStateName = "i_loc_stt" + i + "_";
////                 String strLeName = "i_loc_le" + i;
...
////                     for(ProcessRealtimeDTO dto : gacRealtime)
////                     {
////                         if(tagManage.getItm().equalsIgnoreCase(strStateName + CommonValue.GAC_STATE_FILTER) == true &&
////                                 tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true &&
...
////                             break;
////                         }
////                         else if(tagManage.getItm().equalsIgnoreCase(strStateName + CommonValue.GAC_STATE_RELAX) == true &&
////                                 tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true &&
////                                 Float.parseFloat(dto.getTag_val()) > 0)
////                         {
////                             // 현재 지별 상태를 저장하고 지별 상태 중복 확인 값을 증가
...
////                             break;
////                         }
////                         else if(tagManage.getItm().equalsIgnoreCase(strStateName + CommonValue.GAC_STATE_BW) == true &&
////                                 tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true &&
////                                 Float.parseFloat(dto.getTag_val()) > 0)
////                         {
////                             // 현재 지별 상태를 저장하고 지별 상태 중복 확인 값을 증가
...
////                             break;
////                         }
////                         else if(tagManage.getItm().equalsIgnoreCase(strStateName + CommonValue.GAC_STATE_BW_STANDBY) == true &&
////                                 tagManage.getTag_sn().equalsIgnoreCase(dto.getTag_sn()) == true &&
////                                 Float.parseFloat(dto.getTag_val()) > 0)
////                         {
////                             // 현재 지별 상태를 저장하고 지별 상태 중복 확인 값을 증가
...
//
////                 // 현재 운영지 수
////                 aiGacInfo.put("i_opr_cnt", nOperationCount);
//
////                 // AI 운영지 수 예측
////                 // 데이터 값이 JSON으로 저장되어 있으므로 JSON 처리
////                 mapTemp = objectMapper.readValue(aiGacRealtime.getAi_i_opr_cnt(), LinkedHashMap.class);
...
////                 aiGacInfo.put("ai_i_opr_cnt", objectTemp);
//
////                 // 지별 현재 상태
////                 aiGacInfo.put("i_loc_stt", locationStateMap);
//
////                 // 지별 수위
////                 aiGacInfo.put("i_loc_le", locationLeMap);
//
////                 // 지별 여과 지속 시간
////                 aiGacInfo.put("i_loc_ti", locationTiMap);
//
////                 // AI 지별 여과 지속 시간 예측
////                 // 데이터 값이 JSON으로 저장되어 있으므로 JSON 처리
////                 mapTemp = objectMapper.readValue(aiGacRealtime.getAi_i_loc_ti(), LinkedHashMap.class);
////                 keyList = new ArrayList<>(mapTemp.keySet());
////                 objectTemp = mapTemp.get(keyList.get(0));
////                 aiGacInfo.put("ai_i_loc_ti", objectTemp);
//
////                 // AI 지별 역세 시작 시간 예측
////                 // 데이터 값이 JSON으로 저장되어 있으므로 JSON 처리
////                 mapTemp = objectMapper.readValue(aiGacRealtime.getAi_i_loc_bw_ti(), LinkedHashMap.class);
////                 keyList = new ArrayList<>(mapTemp.keySet());
////                 objectTemp = mapTemp.get(keyList.get(0));
////                 aiGacInfo.put("ai_i_loc_bw_ti", objectTemp);
//
////                 // AI 지별 운영 스케쥴 예측
////                 // 데이터 값이 JSON으로 저장되어 있으므로 JSON 처리
////                 mapTemp = objectMapper.readValue(aiGacRealtime.getAi_i_loc_opr(), LinkedHashMap.class);
////                 keyList = new ArrayList<>(mapTemp.keySet());
////                 objectTemp = mapTemp.get(keyList.get(0));
...
//// //        log.debug("update aiGacOperationMode:[{}], mode:[{}]",
...
////         AiProcessInitDTO aiGacInit = databaseService.getAiGacInit(CommonValue.I_OPERATION_MODE, 2);
////         log.debug("getAiGacInit, result:[{}]", aiGacInit != null ? 1 : 0);
//
...
////             controlMap.put("tag", aiGacInit.getTag_sn());
...
////             {
////                 if(dto.getItm().equalsIgnoreCase("i_operation_mode_a") == true)
////                 {
////                     // Kafka에 전송할 값 정의
...
////         log.debug("putTiControlGac, ti:[{}]", nTi);
//
////         // 잘못된 시간 값 검사
////         if(nTi < 0)
////         {
...
////         log.debug("modAiGacInitTi, result:[{}]", nResult);
//
////         if(nResult > 0)
////         {
////             return new ResponseEntity<>("", HttpStatus.OK);
