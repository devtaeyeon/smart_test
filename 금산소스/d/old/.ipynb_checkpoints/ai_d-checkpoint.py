...
def perform(db, job_datetime=None):
    try : 
        ...
        # JSON 형 변환 
        factor_val_json = rslt_val(val=factor_val,val_col=[]) # 재확인 
        ...
        # 알람 팝업 주기 
        # pre_alm_yn_1 = 0 # 133005 : 혼화응집 기존 G값 대비 일정범위 이상
        # pre_alm_yn_2 = 0 # 133001 : 혼화응집 AI 제어 
        # pre_alm_yn_3 = 0 # 133004 : 혼화응집 G값 변경
                        ...
                        # 임계치 기준을 초과하지 않는 경우 G값 변경 알람  
                            ...
                            if pre_alm_yn_2 == 0 : 
                                ...
                                if loc_no not in alm_cnt_2 :
                                    # send_alm(db=db,table=tb_ai_d_alm,alm_id=alm_id2,alm_ti=str(pd.to_datetime(df_mixing_ai_result['upd_ti'][0])+timedelta(minutes=int(loc_no)-1)))
